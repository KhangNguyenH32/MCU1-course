...
int main(void)
{
	uint32_t *pRccCtrlReg = (uint32_t*) RCC_BASE_ADDR;

	//1. Enable the HSE clock using HSEON bit (RCC_RC)
	*pRccCtrlReg |= (1 << 16);
 ...
 */
	...
	//a ) Enable the peripheral clock for GPIOA peripheral
	 ...
	 uint32_t *pRCCAhb1Enr = (uint32_t*)(RCC_BASE_ADDR + 0x30);s
