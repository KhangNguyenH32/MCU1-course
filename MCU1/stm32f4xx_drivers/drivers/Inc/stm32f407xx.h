...
typedef struct
{
	__vo uint32_t CR1;		// IC2 control register 1, address offset: 0x00
	__vo uint32_t CR2;		// IC2 control register 2, address offset: 0x04
	__vo uint32_t OAR1;		// IC2 own adress register 1, address offset: 0x08
	__vo uint32_t OAR2;		// IC2 own adress register 2, address offset: 0x0C
	__vo uint32_t DR;		// IC2 data register, address offset: 0x10
	__vo uint32_t SR1;		// IC2 status register 1, address offset: 0x14
	__vo uint32_t SR2;		// IC2 status register 2, address offset: 0x18
